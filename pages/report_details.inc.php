...
$reportTabsId = 'reportTabs'.($issueFormat?'-'.$reportId:''); 
?>
<div class="tabbable <?php echo ($issueFormat?'tabs-top':'tabs-top'); ?>">
	<ul id="<?php echo $reportTabsId; ?>" class="nav nav-<?php echo ($issueFormat?'pills':'tabs'); ?>" >
...
<script>
  $(function () { $('#<?php echo $reportTabsId; ?> a:first').tab('show'); });
</script>
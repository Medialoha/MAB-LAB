...
@session_start();
if (!isset($_SESSION['asset_colors_id'])) {
 	$_SESSION['asset_colors_id'] = uniqid('', true);
}

if (!defined('HOLO_COLORS_PATH'))
	define('HOLO_COLORS_PATH', './');

define('HOLO_COLORS_COMPONENTS_PATH', HOLO_COLORS_PATH.'widgets/');
define('HOLO_COLORS_GEN_DIR', '../../pubfiles/_holocolors/');

include_once(HOLO_COLORS_PATH.'include/php/log4php/Logger.php');
include_once(HOLO_COLORS_PATH.'common.php');
...
Logger::configure(array( 'rootLogger' => array( 'appenders'=>array('default'), ),
    										 'appenders' => array(
    													...
    													'params' => array( 
    															'file' => HOLO_COLORS_PATH.'../../logs/asset-studio-colors-genall.log',
    															'append' => true 
																)
    												)
    										)));
...
$date = date("Ymd");
$root_folder = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'];
...
date_default_timezone_set('UTC');
$date = date("Ymd");
$folder = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'];
...
if (isset($edittext) && $edittext == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'edittext/common-edittext.php');
...
if (isset($text_handle) && $text_handle == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/text_handle/common-text_handle.php');
...
if (isset($autocomplete) && $autocomplete == true) {
    ...
    if (!isset($list)) {
        require_once(HOLO_COLORS_COMPONENTS_PATH.'/list/common-list.php');
...
if (isset($checkbox) && $checkbox == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/checkbox/common-checkbox.php');
...
if ((isset($radio) && $radio == true) || ((isset($spinner) && $spinner == true) || (isset($cspinner) && $cspinner == true))) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/radio/common-radio.php');
...
if ((isset($button) && $button == true) || (isset($cbutton) && $cbutton == true)) {
    if ((isset($button) && $button == true) && (!isset($cbutton))) {
        require_once(HOLO_COLORS_COMPONENTS_PATH.'/button/common-button.php');
        ...
        require_once(HOLO_COLORS_COMPONENTS_PATH.'/cbutton/common-cbutton.php');
...
if (isset($cspinner) && $cspinner == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/cspinner/common-cspinner.php');
...
if (isset($spinner) && $spinner == true && !isset($cspinner)) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/spinner/common-spinner.php');
...
if (isset($tab) && $tab == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/tab/common-tab.php');
...
if (isset($seekbar) && $seekbar == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/seekbar/common-seekbar.php');
...
if (isset($ratingbar) && $ratingbar == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/ratingbar/common-ratingbar.php');
...
if (isset($ratingstarbig) && $ratingstarbig == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/ratingstarbig/common-ratingstarbig.php');
...
if (isset($ratingstarsmall) && $ratingstarsmall == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/ratingstarsmall/common-ratingstarsmall.php');
...
if (isset($toggle) && $toggle == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/toggle/common-toggle.php');
...
if (isset($fastscroll) && $fastscroll == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/fastscroll/common-fastscroll.php');
...
if (isset($search) && $search == true) {
  require_once(HOLO_COLORS_COMPONENTS_PATH.'/search/common-search.php');
...
if (isset($numberpicker) && $numberpicker == true) {
    ...
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/numberpicker/common-numberpicker.php');
...
if (isset($switchjb) && $switchjb == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/switchjb/common-switchjb.php');
...
if (isset($switch) && $switch == true) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/switch/common-switch.php');
...
if ((isset($navdrawer) && $navdrawer == true)) {
    require_once(HOLO_COLORS_COMPONENTS_PATH.'/navdrawer/common-navdrawer.php');
...
if ($minsdk == 'holo') {
    $theme_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values/themes_" . $lower_name . ".xml";
    @file_put_contents($theme_file, $themev11);
} else {
    if ($themev11_available) {
        $theme_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v11/themes_" . $lower_name . ".xml";
        @file_put_contents($theme_file, $themev11);
    }
    ...
    if ($themev9_available) {
        $theme_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v9/themes_" . $lower_name . ".xml";
        @file_put_contents($theme_file, $themev9);
    }
}

if ($style8_available == true && $minsdk != 'holo') {
    $style_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values/styles_" . $lower_name . ".xml";
...
if ($style11_available == true) {
    if ($minsdk == 'holo') {
        ...
        $style_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v11/styles_" . $lower_name . ".xml";
    }
...
if ($style14_available == true) {
    $values14 = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v14";
    if (file_exists($values14) == FALSE) {
        mkdir($values14, 0777, true);
    }
    $theme_file = "generated/" . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v14/themes_" . $lower_name . ".xml";
...
function generateImageOnDisk($clazz, $color, $holo, $kitkat = false, $ctx = "")
{
    ...
    foreach ($sizes as $size) {
        $obj->generate_image($color, $size, $holo, $kitkat=false);
    }
}
...
function generateFolders($date, $themev8_available, $themev9_available, $themev11_available) {
  ...
  $drawable = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'] . "/res/drawable";
  $layout = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'] . "/res/layout";	
    ...
    $values = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values";
    if (file_exists($values) == FALSE) {
        mkdir($values, 0777, true);
    }
    if ($themev8_available) {
        if ($themev11_available) {
            $values11 = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v11";
        ...
        if ($themev9_available) {
            $values9 = HOLO_COLORS_GEN_DIR   . $date . "/" . $_SESSION['asset_colors_id'] . "/res/values-v9";

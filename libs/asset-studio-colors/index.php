...
Logger::configure(array( 'rootLogger' => array( 'appenders'=>array('default'), ),
    										 'appenders' => array(
    													...
    													'params' => array( 
    															'file' => HOLO_COLORS_PATH.'../../logs/asset-studio-colors.log',
    															'append' => true 
																)
    												)
    										)));
...
if (isset($_GET['do'])) {
	if (strcmp($_GET['do'], 'gen')==0) {
		$c = explode('-', $_GET['component']);
		
		require_once(HOLO_COLORS_COMPONENTS_PATH.$c[0].'/'.$c[0].'.php');
	}
...
<div id="main-container">
	...
	<div id="page-header">
		...
		<p id="page-intro" style="width: 820px">
			The <strong>Android Holo Colors Generator</strong> allows you to
			easily create Android components such as editext or spinner with your
			own colours for your Android application. It will generate all
			necessary nine patch assets plus associated XML drawables and styles
			which you can copy straight into your project. <br /> If you have any
			question, please refer to the <a href="faq.html">FAQ</a> or <a
				href="https://github.com/jeromevdl/android-holo-colors/issues"
	...
	<div id="outputs">
		<table>
			<tr>
				<td style="width: 45%"><b>Output resources</b> (<i>zip file contains
						a "res" folder</i>):</td>
				<td><a class="dragout form-button"
					onclick="javascript:downloadFile();">Download .ZIP</a></td>
			</tr>
		</table>
		<br />
...
-->
	...
	<div id="footer">
		<p>
			Created by <a href="mailto:jeromevdl@android-holo-colors.com">Jérôme
				Van Der Linden</a>.
		</p>

		<p>
			Built upon the <a href="http://code.google.com/p/android-ui-utils"
				target="_blank">android-ui-utils</a> asset studio framework created
			by <a href="http://roman.nurik.net/" target="_blank">Roman Nurik</a>,
			copyright Google Inc.
		</p>
		<br />

		<p>
			All generated art is licensed under a <a rel="license"
				href="http://creativecommons.org/licenses/by/3.0/" target="_blank">Creative
		...
		<div align="center">
			<span class='st_twitter_hcount' displayText='Tweet'></span> <span
				class='st_plusone_hcount' displayText='Google +1'></span> <span
				class='st_googleplus_hcount' displayText='Google +'></span> <span
				class='st_yammer_hcount' displayText='Yammer'></span> <span
				class='st_sharethis_hcount' displayText='ShareThis'></span> <span
				class='st_facebook_hcount' displayText='Facebook'></span> <span
				class='st_linkedin_hcount' displayText='LinkedIn'></span> <span
				class='st_viadeo_hcount' displayText='Viadeo'></span> <span
				class='st_delicious_hcount' displayText='Delicious'></span> <span
				class='st_tumblr_hcount' displayText='Tumblr'></span> <span
				class='st_reddit_hcount' displayText='Reddit'></span> <span
...
function downloadFile() {
    ...
    var url = BASE_PATH+'generate_all.php?origin=web&color=' + color + '&holo=' + values['theme'] + '&name=' + values['name'].replace(/\s+/g, '') + '&kitkat=' + kitkatint + "&minsdk=" + values['minsdk'] + "&compat=" + values['compat'];
...
function dogenerate(comp, density, color) {
    ...
    if (values[component]) {
        ...
        var kitkat = values['kitkat'];
        var kitkatint = kitkat ? 1 : 0;
        $('#out-' + comp + '-' + density).attr('src', BASE_PATH+"index.php?do=gen&color=" + color + "&size=" + density + "&holo=" + theme + "&kitkat=" + kitkatint + "&action=display&component=" + comp);

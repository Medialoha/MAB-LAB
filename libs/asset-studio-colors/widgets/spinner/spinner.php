...
if (isset($color) && isset($size) && isset($holo) && isset($component) && isset($kitkat)) {
    switch ($component) {
        case "spinner":
            $sp = new Spinner(HOLO_COLORS_COMPONENTS_PATH.'/spinner/');
            break;
        case "spinner-focus":
            $sp = new SpinnerFocus(HOLO_COLORS_COMPONENTS_PATH.'/spinner/');
            break;
        case "spinner-pressed":
            $sp = new SpinnerPress(HOLO_COLORS_COMPONENTS_PATH.'/spinner/');
            break;
        default:
            $sp = new Spinner(HOLO_COLORS_COMPONENTS_PATH.'/spinner/');
            break;

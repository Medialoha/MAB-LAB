...
if (isset($color) && isset($size) && isset($holo) && isset($component) && isset($kitkat)) {
    ...
    switch ($component) {
        case "switchjb":
            $toggle = new SwitchJBThumbActivated(HOLO_COLORS_COMPONENTS_PATH.'/switchjb/');
            break;
        case "switchjb-pressed":
            $toggle = new SwitchJBThumbPress(HOLO_COLORS_COMPONENTS_PATH.'/switchjb/');
            break;
        case "switchjb-bg":
            $toggle = new SwitchJBBackground(HOLO_COLORS_COMPONENTS_PATH.'/switchjb/');
            break;
        default:
            $toggle = new SwitchJBThumbActivated(HOLO_COLORS_COMPONENTS_PATH.'/switchjb/');
            break;

...
if (isset($color) && isset($size) && isset($holo) && isset($component)) {
    switch ($component) {
        case "edittext":
            $et = new EditText(HOLO_COLORS_COMPONENTS_PATH.'/edittext/');
            break;
        case "edittext-activated":
            $et = new EditTextActivate(HOLO_COLORS_COMPONENTS_PATH.'/edittext/');
            break;
        case "edittext-focus":
            $et = new EditTextFocus(HOLO_COLORS_COMPONENTS_PATH.'/edittext/');
            break;
        default:
            $et = new EditText(HOLO_COLORS_COMPONENTS_PATH.'/edittext/');
            break;
